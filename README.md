...
only "login"). Move each with WASD or arrow keys - movement should feel
...
3. **Better collision/tilemap authoring** - load a Tiled JSON map instead of
   ...
   (and now client-side prediction too).
...
6. **Configurable external port** - if you ever need the client to connect
