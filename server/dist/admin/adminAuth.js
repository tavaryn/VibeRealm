 ...
 * console input only).
 */
const ADMINS_FILE = path_1.default.join(__dirname, "..", "..", "data", "admins.json");
function loadFileAdmins() {
    try {
        if (!fs_1.default.existsSync(ADMINS_FILE)) {
            fs_1.default.mkdirSync(path_1.default.dirname(ADMINS_FILE), { recursive: true });
            fs_1.default.writeFileSync(ADMINS_FILE, JSON.stringify([], null, 2));
            return [];
        }
        const raw = fs_1.default.readFileSync(ADMINS_FILE, "utf-8");
